...
const Step2: React.FC<Step2Props> = React.memo(({ nextStep, prevStep }) => (
  <PopupContent>
    ...
    <p className="text-[#5D552F] mb-8 text-lg leading-relaxed font-normal">
      I use advanced AI to help you understand yourself better. I call you at a
      time that works for you, right on your cellphone so you can talk to me
      during a commute or a walk. And you don't forget to reflect, ever!
    </p>
